...
Once again, run your applications with `podman-compose up -d` and send request to `api/profile-value` endpoint. Does the response change based on the profile the app is run with?
